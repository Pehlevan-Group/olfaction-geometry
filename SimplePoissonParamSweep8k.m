...
save(['results_8k/thresh_' id '.mat'], 'results');
save(['results_8k/compk_' id '.mat'], 'results_compk');


%% Load saved files
directory = 'remote/results_8k';
...
title('After 100 ms')
legend()
saveas(gcf, 'fig/prop_correct_fast.fig')
hold off;
...
title('After 200 ms')
legend()
saveas(gcf, 'fig/prop_correct_med.fig')
hold off;
...
title('After 1 s')
legend()
saveas(gcf, 'fig/prop_correct_long.fig')
hold off;
...
title('After 100 ms')
legend()
saveas(gcf, 'fig/prop_correct_fast_compk.fig')
hold off;
...
title('After 200 ms')
legend()
saveas(gcf, 'fig/prop_correct_med_compk.fig')
hold off;
...
title('After 1 s')
legend()
saveas(gcf, 'fig/prop_correct_long_compk.fig')
hold off;
...
title('Naive')
saveas(gcf, 'fig/heatmap_naive.fig');
...
saveas(gcf, 'fig/heatmap_naive_dist.fig')
...
ylabel('number of odors')
title('Geometric')
saveas(gcf, 'fig/heatmap_geom.fig')
...
ylabel('number of odors')
title('Naive')
saveas(gcf, 'fig/heatmap_naive_compk.fig')
...
ylabel('number of odors')
title('Naive Distributed')
saveas(gcf, 'fig/heatmap_naive_dist_compk.fig')
...
ylabel('number of odors')
title('Geometric')
saveas(gcf, 'fig/heatmap_geom_compk.fig')
